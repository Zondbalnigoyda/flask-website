...
@app.route("/")
def hello():
    return '<h1>Привет, Здесь у тебя есть возможность узнать случайный факт о технологической зависимости!</h1><a href="/random_fact">Посмотреть случайный факт!</a>'
...
def cubick():
    ...
    return f'<h1>Подбрасываю кубик...</h1><h1>Выпало число {kub_num}</h1>'
